...
type alias QuestionState = { question : Question.State
...
mkQBatch : List System -> State -- List Question
mkQBatch eqs =
  { questions = List.indexedMap mkQuestion eqs }

init : List Equation -> Model
init eqs =
  let
