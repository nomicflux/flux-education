...
Elm.Lesson6 = Elm.Lesson6 || {};
Elm.Lesson6.make = function (_elm) {
   "use strict";
   _elm.Lesson6 = _elm.Lesson6 || {};
   if (_elm.Lesson6.values) return _elm.Lesson6.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var targetToSubmission = F4(function (address,qid,bid,val) {
      ...
      address,
      A2(Submission,{ctor: "_Tuple2",_0: qid,_1: bid},mNumVal));
   });
   var viewQuestion = F2(function (address,_p15) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Question.makeMath(A2($Basics._op["++"],
                      "     x = ",
                      A2($Basics._op["++"],s2,A2($Basics._op["++"]," - ",s1))))]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([$Html.text("x  = ")
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.type$("text")
                                      ...
                                      A3(targetToSubmission,address,_p19.id,"x"))]),
                              _U.list([]))
                              ,A2($Html.button,
   ...
   var init = function () {
      var pairToLine = function (l) {
         ...
         if (_p20.ctor === "::" && _p20._1.ctor === "::") {
               ...
               return _U.list([_U.list([{ctor: "_Tuple2"
                                        ...
                                        ,_1: $Color.blue}
                                       ,{ctor: "_Tuple2"
                                        ,_0: $NumberLine.Constant({value: _p21})
                                        ,_1: $Color.red}])
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.Constant({value: _p22})
                                        ,_1: $Color.green}])
                              ,_U.list([])
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.Variable({name: "x"
                              ...
                              ,_U.list([{ctor: "_Tuple2"
                                        ...
                                        ,_1: $Color.green}
                                       ,{ctor: "_Tuple2"
                                        ,_0: $NumberLine.Constant({value: 0 - _p21})
                                        ,_1: $Color.lightCharcoal}])]);
            } else {
               return _U.list([]);
            }
      };
      var numPairs = _U.list([_U.list([2,5])
                             ,_U.list([5,12])
                             ,_U.list([40,42])]);
      ...
      var validate = F2(function (nums,guess) {
         ...
         if (_p23.ctor === "::" && _p23._1.ctor === "::") {
               return $Maybe.Just(_U.eq(_p23._0 + guess,_p23._1._0));
            } else {
               return $Maybe.Nothing;
            }
      });
      var questions = A2($Question.mkQBatch,
      _U.list([{ctor: "_Tuple2",_0: "x",_1: validate}]),
      numPairs);
   ...
   return _elm.Lesson6.values = {_op: _op
