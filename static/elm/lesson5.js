...
Elm.NumberLine.make = function (_elm) {
   ...
   var numberBarToRect = F3(function (scale,height,nl) {
      ...
      nl.start * scale + width / 2,
      A2($Graphics$Collage.filled,
      nl.color,
      A2($Graphics$Collage.rect,width,height)));
   });
   var addBars = F2(function (x,y) {
      return {start: y.start + y.size + x.start
             ,size: x.size
             ,color: x.color};
   });
   var scanBars = function (bars) {
      return A3($List.scanl,
      addBars,
      {start: 0,size: 0,color: $Color.black},
      bars);
   };
   var makeFullBar = F4(function (scale,dims,ypos,bars) {
      var rectIt = A2(numberBarToRect,
      scale,
      ...
      if (_p6.ctor === "Constant") {
            ...
            if (_p7.ctor === "Constant") {
                  ...
                  return _U.eq(_p9.name,_p8.name) ? Variable({name: _p9.name
                                                             ,value: _p8.value
                                                             ,prevValue: _p9.value}) : Variable({name: _p9.name
                                                                                                ,value: _p9.value
                                                                                                ,prevValue: _p9.value});
               }
         }
...
Elm.Question.make = function (_elm) {
   ...
   var updateBox = F3(function (wantedBid,val,box) {
      return _U.eq(box.id,wantedBid) ? _U.update(box,
      {attempted: true
      ,completed: A2(validateBox,box,val)
      ,guess: $Maybe.Just(val)}) : box;
   });
   var updateQuestion = F3(function (_p0,val,question) {
      var _p1 = _p0;
      return _U.eq(question.id,_p1._0) ? _U.update(question,
      {boxes: A2($List.map,
      A2(updateBox,_p1._1,val),
   ...
   var mkQuestion = F3(function (validations,qid,nums) {
      ...
      function (_p2) {
         var _p3 = _p2;
         return {ctor: "_Tuple2",_0: _p3._0,_1: _p3._1(nums)};
      },
      validations);
      return {nums: nums
             ,boxes: A2($List.map,$Basics.uncurry(mkBox),fullValidations)
             ,id: qid + 1};
   });
   ...
   var faClass = F2(function (question,bid) {
      ...
      if (_p4.ctor === "Nothing") {
            ...
            var _p5 = _p4._0;
            return _p5.completed ? "fa fa-check-square-o" : _p5.attempted ? "fa fa-square-o" : "fa fa-square-o";
         }
   });
   var completionClass = F2(function (question,bid) {
      ...
      if (_p6.ctor === "Nothing") {
            ...
            var _p7 = _p6._0;
            return _p7.completed ? "completed" : _p7.attempted ? "incorrect" : "new-question";
         }
   });
   var Question = F3(function (a,b,c) {
      return {nums: a,boxes: b,id: c};
   });
   var InputBox = F5(function (a,b,c,d,e) {
      return {completed: a
             ,attempted: b
             ,validation: c
             ,guess: d
...
Elm.Lesson5.make = function (_elm) {
   ...
   if (_elm.Lesson5.values) return _elm.Lesson5.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "SendCompletion": return {ctor: "_Tuple2"
                                     ...
                                     ,_1: $Effects.none};
         case "Submission": var _p13 = _p8._0._0;
           var _p12 = _p8._0._1;
           var _p9 = _p8._1;
           if (_p9.ctor === "Nothing") {
                 ...
                 var updateThisV = function (s) {
                    ...
                    s,
                    A2($NumberLine.UpdateVariable,_p12,_p11));
                 };
   ...
   var viewQuestion = F2(function (address,_p15) {
      var _p16 = _p15;
      var _p19 = _p16.question;
      var _p17 = function () {
         var _p18 = _p19.nums;
         if (_p18.ctor === "::" && _p18._1.ctor === "::" && _p18._1._1.ctor === "::")
         {
               return {ctor: "_Tuple3"
                      ,_0: $Basics.toString(_p18._0)
                      ,_1: $Basics.toString(_p18._1._0)
                      ,_2: $Basics.toString(_p18._1._1._0)};
            } else {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([$Question.makeMath("x = ")
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.type$("text")
                                      ,$Html$Attributes.$class(A2($Question.completionClass,_p19,"x"))
                                      ,A3($Html$Events.on,
                                      "change",
                                      ...
                                      address,
                                      function (x) {
                                         return A2(Submission,
                                         {ctor: "_Tuple2",_0: _p19.id,_1: "x"},
                                         x);
                                      }))]),
                              _U.list([]))
                              ,A2($Html.button,
                              ...
                              "btn btn-side ",
                              A2($Question.completionClass,_p19,"x")))]),
                      ...
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([$Question.makeMath("y = ")
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.type$("text")
                                      ,$Html$Attributes.$class(A2($Question.completionClass,_p19,"y"))
                                      ,A3($Html$Events.on,
                                      "change",
                                      $Html$Events.targetValue,
                                      A2(targetToSubmission,
                              ...
                              A2($Question.completionClass,_p19,"y")))]),
                              _U.list([A3($Html.node,
                              "i",
                              _U.list([$Html$Attributes.$class(A2($Question.faClass,
                              _p19,
   ...
   var init = function () {
      var triadToLine = function (l) {
         var _p20 = l;
         if (_p20.ctor === "::" && _p20._1.ctor === "::" && _p20._1._1.ctor === "::")
         {
               return _U.list([_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p20._0)
                                        ,_1: $Color.red}
                                       ,{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p20._1._0)
                                        ,_1: $Color.green}])
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkVar("x")
                                        ,_1: $Color.blue}])
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkVar("x")
                                        ,_1: $Color.blue}
                                       ,{ctor: "_Tuple2",_0: $NumberLine.mkVar("y"),_1: $Color.brown}])
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p20._1._1._0)
                                        ,_1: $Color.purple}])]);
            } else {
               return _U.list([]);
            }
      };
      var numTriads = _U.list([_U.list([2,3,9])
                              ,_U.list([5,7,21])
                              ,_U.list([40,1,42])]);
      ...
      numTriads);
      var validateY = F2(function (nums,yguess) {
         var _p21 = nums;
         if (_p21.ctor === "::" && _p21._1.ctor === "::" && _p21._1._1.ctor === "::")
         {
               return $Maybe.Just(_U.eq(_p21._0 + _p21._1._0 + yguess,
               _p21._1._1._0));
            } else {
               return $Maybe.Nothing;
            }
      });
      var validateX = F2(function (nums,xguess) {
         var _p22 = nums;
         if (_p22.ctor === "::" && _p22._1.ctor === "::") {
               return $Maybe.Just(_U.eq(_p22._0 + _p22._1._0,xguess));
            } else {
               return $Maybe.Nothing;
            }
      });
      var questions = A2($Question.mkQBatch,
      _U.list([{ctor: "_Tuple2",_0: "x",_1: validateX}
              ,{ctor: "_Tuple2",_0: "y",_1: validateY}]),
      numTriads);
   ...
   return _elm.Lesson5.values = {_op: _op
