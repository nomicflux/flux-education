...
Elm.Lesson5.make = function (_elm) {
   ...
   var viewQuestion = F2(function (address,question) {
      var _p2 = function () {
         ...
         if (_p3.ctor === "::" && _p3._1.ctor === "::" && _p3._1._1.ctor === "::")
         {
               return {ctor: "_Tuple3"
                      ...
                      ,_2: $Basics.toString(_p3._1._1._0)};
            } else {
      ...
      var s3 = _p2._2;
      var _p4 = function () {
         var _p5 = question.boxes;
         if (_p5.ctor === "::" && _p5._0.ctor === "_Tuple2" && _p5._1.ctor === "::" && _p5._1._0.ctor === "_Tuple2")
         {
               return {ctor: "_Tuple2"
                      ,_0: _p5._0._1.guess
                      ,_1: _p5._1._0._1.guess};
            } else {
               return {ctor: "_Tuple2"
                      ,_0: $Maybe.Nothing
                      ,_1: $Maybe.Nothing};
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Question.makeMath("x = ")
                              ...
                              _U.list([$Html$Attributes.type$("text")
                                      ...
                                      address,
                                      function (x) {
                                         return A3(Submission,question.id,1,x);
                                      }))]),
                              _U.list([]))
                              ,A2($Html.button,
                      ...
                      _U.list([$Question.makeMath("y = ")
                              ...
                              _U.list([$Html$Attributes.type$("text")
                                      ...
                                      address,
                                      function (y) {
                                         return A3(Submission,question.id,2,y);
                                      }))]),
                              _U.list([]))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
                              "btn btn-side btn-inverse ",
                              A2($Question.completionClass,question,2)))]),
                              _U.list([A3($Html.node,
                              "i",
                              _U.list([$Html$Attributes.$class(A2($Question.faClass,
                              question,
   ...
   var init = function () {
      ...
      var validateY = F2(function (nums,yguess) {
         ...
         {
               return $Maybe.Just(_U.eq(_p8._0 + _p8._1._0 + yguess,
               _p8._1._1._0));
            } else {
               return $Maybe.Nothing;
            }
      ...
      var validateX = F2(function (nums,xguess) {
         ...
         if (_p9.ctor === "::" && _p9._1.ctor === "::") {
               return $Maybe.Just(_U.eq(_p9._0 + _p9._1._0,xguess));
            } else {
               return $Maybe.Nothing;
            }
      });
      return {questions: A2($Question.mkQBatch,
             _U.list([validateX,validateY]),
             numTriads)
             ,qAt: 1
             ,completed: false};
   }();
