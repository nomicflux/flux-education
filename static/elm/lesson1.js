...
Elm.Lesson1.make = function (_elm) {
   ...
   if (_elm.Lesson1.values)
   return _elm.Lesson1.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   model) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.href("Lesson2.html")]),
   ...
   var init = {_: {}
              ,phrase: "Addition is a way of combining things."
              ,qAt: 1
