...
Elm.Lesson3 = Elm.Lesson3 || {};
Elm.Lesson3.make = function (_elm) {
   "use strict";
   _elm.Lesson3 = _elm.Lesson3 || {};
   if (_elm.Lesson3.values) return _elm.Lesson3.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Html.text("x  = ")
                              ...
                              _U.list([$Html$Attributes.type$("text")
                                      ,$Html$Attributes.$class(A2($Question.completionClass,_p18,1))
                                      ,A3($Html$Events.on,
                                      "change",
                                      $Html$Events.targetValue,
                                      A3(targetToSubmission,address,_p18.id,1))]),
                              _U.list([]))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
                              "btn btn-side ",
                              A2($Question.completionClass,_p18,1)))]),
                              ...
                              _U.list([]))]))]))]))
              ,A2($NumberLine.view,
              A2($Signal.forwardTo,address,RelayNumberLine(_p18.id)),
              _p15.numberline)]));
   });
   ...
   var init = function () {
      var pairToLine = function (l) {
         ...
         if (_p19.ctor === "::" && _p19._1.ctor === "::") {
               return _U.list([_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.Constant({value: _p19._0})
                                        ,_1: $Color.red}
                                       ,{ctor: "_Tuple2"
                              ...
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.Constant({value: _p19._1._0})
                                        ,_1: $Color.green}])]);
            } else {
               return _U.list([]);
            }
      ...
      var validate = F2(function (nums,guess) {
         ...
         if (_p20.ctor === "::" && _p20._1.ctor === "::") {
               return $Maybe.Just(_U.eq(_p20._0 + guess,_p20._1._0));
            } else {
               return $Maybe.Nothing;
            }
      });
   ...
   return _elm.Lesson3.values = {_op: _op
