...
Elm.Lesson4.make = function (_elm) {
   ...
   if (_elm.Lesson4.values) return _elm.Lesson4.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "SendCompletion": return {ctor: "_Tuple2"
                                     ...
                                     ,_1: $Effects.none};
         case "Submission": var _p12 = _p8._0._0;
           var _p9 = _p8._1;
           if (_p9.ctor === "Nothing") {
                 ...
                 {ctor: "_Tuple2",_0: _p12,_1: _p8._0._1},
                 _p11);
   ...
   var targetToSubmission = F3(function (address,ids,val) {
      var mNumVal = $Result.toMaybe($String.toInt(val));
      return A2($Signal.message,address,A2(Submission,ids,mNumVal));
   });
   var viewQuestion = F2(function (address,_p14) {
      var _p15 = _p14;
      var _p20 = _p15.question;
      var _p16 = function () {
         var _p17 = _p20.nums;
         if (_p17.ctor === "::" && _p17._1.ctor === "::" && _p17._1._1.ctor === "::")
         {
               return {ctor: "_Tuple3"
                      ...
                      ,_2: $Basics.toString(_p17._1._1._0)};
            } else {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      A2($Basics._op["++"],
                      s3,
                      A2($Basics._op["++"]," = ",$Basics.toString(n1 + n2 + n3)))))]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([$Html.text("x = ")
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.type$("text")
                                      ,$Html$Attributes.$class(A2($Question.completionClass,_p20,1))
                                      ,A3($Html$Events.on,
                                      "change",
                                      $Html$Events.targetValue,
                                      A2(targetToSubmission,
                                      address,
                                      {ctor: "_Tuple2",_0: _p20.id,_1: 1}))]),
                              _U.list([]))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
                              "btn btn-side ",
                              A2($Question.completionClass,_p20,1)))]),
                              ...
                              _U.list([]))]))]))]))
              ,A2($NumberLine.view,
              A2($Signal.forwardTo,address,RelayNumberLine(_p20.id)),
              _p15.numberline)]));
   });
   ...
   var init = function () {
      var triadToLine = function (l) {
         ...
         if (_p21.ctor === "::" && _p21._1.ctor === "::" && _p21._1._1.ctor === "::")
         {
               ...
               return _U.list([_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p22)
                                        ,_1: $Color.red}
                                       ,{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p23)
                                        ,_1: $Color.green}])
                              ...
                              ,_U.list([{ctor: "_Tuple2"
                                        ...
                                        ,_1: $Color.blue}
                                       ,{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p24)
                                        ,_1: $Color.brown}])
                              ,_U.list([{ctor: "_Tuple2"
                                        ,_0: $NumberLine.mkConstant(_p22 + _p23 + _p24)
                                        ,_1: $Color.purple}])]);
            } else {
               return _U.list([]);
            }
      };
      var numTriads = _U.list([_U.list([2,3,4])
                              ,_U.list([5,7,9])
                              ,_U.list([40,1,1])]);
      ...
      var validate = F2(function (nums,guess) {
         var _p25 = nums;
         if (_p25.ctor === "::" && _p25._1.ctor === "::" && _p25._1._1.ctor === "::")
         {
               return $Maybe.Just(_U.eq(_p25._0 + _p25._1._0,guess));
            } else {
               return $Maybe.Nothing;
            }
      });
   ...
   return _elm.Lesson4.values = {_op: _op
