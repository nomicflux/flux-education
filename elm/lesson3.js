...
Elm.Lesson3.make = function (_elm) {
   ...
   if (_elm.Lesson3.values)
   return _elm.Lesson3.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
                 ...
                 {case "Just":
                    return function () {
                         var updateQuestion = function (question) {
                            ...
                            _v0._0) ? function () {
                               var completed = _U.eq(question.num1 + _v0._1._0,
                               question.num2);
   ...
   model) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.href("Lesson4.html")]),
         _L.fromArray([$Html.text("Go to Lesson 4")]))])) : A2($Html.div,
         ...
         _L.fromArray([$Html$Attributes.$class("jumbotron lesson3")]),
         A2($Basics._op["++"],
         _L.fromArray([A2($Html.h1,
                      _L.fromArray([]),
                      _L.fromArray([$Html.text("Lesson 3")]))
                      ,A2($Html.h2,
   ...
   var init = {_: {}
              ,phrase: "Sometimes we have the answer and need the question."
              ,qAt: 1
              ,questions: _L.fromArray([A3(mkQuestion,
                                       2,
                                       5,
                                       1)
                                       ,A3(mkQuestion,5,12,2)
                                       ,A3(mkQuestion,40,42,3)])};
