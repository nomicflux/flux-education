...
Elm.Lesson4.make = function (_elm) {
   ...
   model) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.href("Lesson5.html")]),
         _L.fromArray([$Html.text("Go to Lesson 5")]))])) : A2($Html.div,
         ...
         _L.fromArray([$Html$Attributes.$class("jumbotron lesson4")]),
         A2($Basics._op["++"],
         _L.fromArray([A2($Html.h1,
                      _L.fromArray([]),
                      _L.fromArray([$Html.text("Lesson 4")]))
                      ,A2($Html.h2,
   ...
   var init = {_: {}
              ,phrase: "Some questions can be answered together."
              ,qAt: 1
